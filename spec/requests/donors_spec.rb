...
RSpec.describe "/donors", type: :request do
  ...
  # DonorsController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get donors_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Donor" do
        expect {
          post donors_url,
               params: { donor: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Donor" do
        expect {
          post donors_url,
               params: { donor: invalid_attributes }, as: :json
        }.to change(Donor, :count).by(0)
      end

      it "renders a JSON response with errors for the new donor" do
        post donors_url,
             params: { donor: invalid_attributes }, headers: valid_headers, as: :json
    ...
    context "with valid parameters" do
      ...
      it "updates the requested donor" do
        ...
        patch donor_url(donor),
              params: { donor: new_attributes }, headers: valid_headers, as: :json
        donor.reload
  ...
  describe "DELETE /destroy" do
    it "destroys the requested donor" do
      donor = Donor.create! valid_attributes
      expect {
        delete donor_url(donor), headers: valid_headers, as: :json
      }.to change(Donor, :count).by(-1)
    end
  end
end
