...
s1 = Story.create(title: "Kenya Kesho Girls School", beneficiary_story: "A form-two student from Kenya Kesho Girls School says she is lucky to get menstrual pads from a local non-governmental organization known as Hope Africa that empowers young girls and women in the country.
...
s2 = Story.create(title: "St. Mary's School for Girls", beneficiary_story: "While the transition to womanhood should be a celebrated phase by the majority of girls, it can be a daunting challenge especially when they have no access to the much-needed essentials such as dignity kits and information.
...
The project funded by Nia Africa aims to enlighten school-going girls on menstruation and the most recommended practices on menstrual hygiene management as well as increasing dependence on reusable products among young girls and women in the community.", charity_id: c1.id, beneficiary_id: b2.id, inventory_id: inv1.id)

s3 = Story.create(title: " St. Bernard's Girls School", beneficiary_story: "MORE THAN 3,500 GIRLS AND STILL COUNTING
...
So far so good as the One Girl Can team has been able to reach over 3,500 girls by providing them with Sanitary towels and training sessions geared to leadership. This is a big milestone towards the achievement of their studies.", charity_id: c1.id, beneficiary_id: b3.id, inventory_id: inv1.id)

s4 = Story.create(title: "Kenya Kesho Girls School", beneficiary_story: "“My name is Kalondu, my mother got married at the age of 12years to a 70years old man, it was ok then and everyone ahead of her had followed the same path. She quickly gave birth to me a year after, and the next year and soon she was a mother of seven, her health has deteriorated over time, and since my father who was the sole bread winner passed on there was no hope for school or an education for me and my siblings.”
