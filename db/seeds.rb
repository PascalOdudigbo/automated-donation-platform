...
s1 = Story.create(beneficiary_story: "A form-two student from Kenya Kesho Girls School says she is lucky to get menstrual pads from a local non-governmental organization known as Hope Africa that empowers young girls and women in the country.
...
The  sanitary towel program was initiated in 2011 and has so far benefited over 11.2 million girls, mostly in marginalised and slum areas.", charity_id: c1.id, beneficiary_id: b1.id, inventory_id: inv1.id)
s2 = Story.create(beneficiary_story: "While the transition to womanhood should be a celebrated phase by the majority of girls, it can be a daunting challenge especially when they have no access to the much-needed essentials such as dignity kits and information.
