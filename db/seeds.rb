...
The  sanitary towel program was initiated in 2011 and has so far benefited over 11.2 million girls, mostly in marginalised and slum areas.")
s2 = Story.create(beneficificiary_story: "While the transition to womanhood should be a celebrated phase by the majority of girls, it can be a daunting challenge especially when they have no access to the much-needed essentials such as dignity kits and information.
